...
import 'package:reproeduser/pages/puberrepro/puberreproman/reproduksi/reproindex.dart';
              ...
              children: [
                ...
                ListView.separated(
                  ...
                  itemBuilder: (context, index) => InkWell(
                    onTap: () {
                      context.pushReplacement(RerpoIndexMan(
                        dataMateri: dataMateriReproduksiPria,
                        selectedMateri: dataMateriReproduksiPria[index],
                      ));
                    },
                    child: Card(
